...
import cn.qicainiao.guoneilvyou_qi1.R;
...
import com.qcn.wzlz.AdInfo;
import com.qcn.wzlz.AdView;
import com.qcn.wzlz.AppConnect;
import com.qcn.wzlz.MiniAdView;
import com.qcn.wzlz.UpdatePointsNotifier;
...
public class DemoApp extends Activity implements View.OnClickListener, UpdatePointsNotifier {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		AppConnect.getInstance("ee4b33a18548c4114e09e88d04e07a31", "WAPS", this);
		...
		// 使用自定义的OffersWebView
		AppConnect.getInstance(this).setAdViewClassName("cn.waps.demo188.MyAdView");
		...
		Button tuanOffersButton = (Button) findViewById(R.id.tuanOffersButton);
		...
		tuanOffersButton.setOnClickListener(this);
